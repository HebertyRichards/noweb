...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div className="p-8 border rounded-2xl bg-white border-gray-200 hover:border-lime-300 transition-colors duration-300">
      ...
      <div className="flex justify-end mt-6">
        <button className="h-14 w-14 rounded-full flex items-center justify-center border-2 border-gray-300 text-gray-400 hover:bg-lime-300 hover:text-black transition-colors duration-300">
