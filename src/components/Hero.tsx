export function Hero() {
  return (
    <>
      <main className="container mx-auto px-4 sm:px-8 pt-12 pb-20 md:pt-20 md:pb-28 overflow-x-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col items-center lg:items-start">
              <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[8rem] font-["Gallery_Modern"] font-bold text-gray-800 leading-none tracking-tight'>
                Digital
              </h1>
              <div className="flex flex-col lg:flex-row items-center gap-y-8 lg:gap-x-16 mt-4">
                <div className="flex items-center">
                  <div className="bg-lime-300 text-black font-bold py-4 px-6 md:py-6 md:pl-8 md:pr-11 rounded-2xl text-base md:text-lg tracking-wider shrink-0">
                    WEB DESIGN
                  </div>
                  <div className="h-16 w-16 md:h-20 md:w-20 rounded-2xl bg-black flex items-center justify-center shrink-0 z-10 -ml-7">
                    <img
                      src="/Avatar.svg"
                      alt="Web Design Icon"
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-y-10 lg:gap-x-12">
            <div className="max-w-md flex flex-col gap-y-4">
              <p className="text-lg text-gray-600 leading-relaxed text-center lg:text-left">
                We believe that the surest measure of success is our partnership
                with you. It’s more than just the visuals; we're here to support
                your growth.
              </p>
              <a
                href="#"
